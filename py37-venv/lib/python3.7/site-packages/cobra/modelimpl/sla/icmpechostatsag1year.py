...
# ##################################################
class ICMPEchoStatsAg1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.ICMPEchoStatsAg1year", "ICMP Echo Operation Statistics")
    ...
    meta.moClassName = "slaICMPEchoStatsAg1year"
    meta.rnFormat = "CDslaICMPEchoStatsAg1year"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current aggregated ICMP Echo Operation Statistics stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('CDslaICMPEchoStatsAg1year', False),
    ]
