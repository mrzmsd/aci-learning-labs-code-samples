...
# ##################################################
class TCPConnectStatsAgHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.sla.TCPConnectStatsAgHist1w", "TCP Connect Operation Statistics")
    ...
    meta.moClassName = "slaTCPConnectStatsAgHist1w"
    meta.rnFormat = "HDslaTCPConnectStatsAg1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated TCP Connect Operation Statistics stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 49967, PropCategory.REGULAR)
