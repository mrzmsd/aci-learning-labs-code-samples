...
# ##################################################
class If(Mo):
    meta = ClassMeta("cobra.model.fcoe.If")

    meta.isAbstract = True
    meta.moClassName = "fcoeIf"
    ...
    meta.concreteSubClasses.add("cobra.model.fcoe.VfcIf")
    meta.concreteSubClasses.add("cobra.model.fcoe.FcBrIf")
    meta.concreteSubClasses.add("cobra.model.fcoe.FcAggrIf")
    ...
    prop = PropMeta("str", "id", "id", 45451, PropCategory.REGULAR)
