...
# ##################################################
class TunnelIfStats(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.hctunn.TunnelIfStats")

    meta.moClassName = "hctunnTunnelIfStats"
    meta.rnFormat = "tunnelifstats-%(id)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "egrUnicastBytes", "egrUnicastBytes", 50466, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("egrUnicastBytes", prop)

    prop = PropMeta("str", "egrUnicastPkts", "egrUnicastPkts", 50465, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("egrUnicastPkts", prop)

    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51659, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 50459, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "ingrDropBytes", "ingrDropBytes", 50464, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ingrDropBytes", prop)

    prop = PropMeta("str", "ingrDropPkts", "ingrDropPkts", 50462, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ingrDropPkts", prop)

    prop = PropMeta("str", "ingrUnicastBytes", "ingrUnicastBytes", 50463, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("ingrUnicastBytes", prop)

    prop = PropMeta("str", "ingrUnicastPkts", "ingrUnicastPkts", 50461, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "vrfName", "vrfName", 50460, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
