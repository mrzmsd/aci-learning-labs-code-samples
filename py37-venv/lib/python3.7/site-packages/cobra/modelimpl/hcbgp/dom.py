...
class Dom(Mo):
    ...
    meta = ClassMeta("cobra.model.hcbgp.Dom")

    meta.moClassName = "hcbgpDom"
    ...
    meta.childClasses.add("cobra.model.hcbgp.DomAf")
    meta.childClasses.add("cobra.model.hcbgp.Peer")

    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.Peer", "peer-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcbgp.DomAf", "af-"))
    ...
    prop = PropMeta("str", "holdIntvl", "holdIntvl", 50211, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "kaIntvl", "kaIntvl", 50210, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "maxAsLimit", "maxAsLimit", 50212, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "name", "name", 50727, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "numEstPeers", "numEstPeers", 50216, PropCategory.REGULAR)
    prop.label = "Number of Established Peers"
    prop.isOper = True
    meta.props.add("numEstPeers", prop)

    prop = PropMeta("str", "numPeers", "numPeers", 50215, PropCategory.REGULAR)
    prop.label = "Number of Peers"
    prop.isOper = True
    meta.props.add("numPeers", prop)

    prop = PropMeta("str", "operSt", "operSt", 50214, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rd", "rd", 50213, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "rtrId", "rtrId", 50209, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 50208, PropCategory.REGULAR)
