...
# ##################################################
class ANexthop(Mo):
    meta = ClassMeta("cobra.model.hcurib.ANexthop")

    meta.isAbstract = True
    meta.moClassName = "hcuribANexthop"


    meta.moClassName = "hcuribANexthop"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Nexthop record"
    ...
    meta.concreteSubClasses.add("cobra.model.hcurib.Nexthop")

    meta.rnPrefixes = [
    ]

    prop = PropMeta("str", "addr", "addr", 55544, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "if", "if", 55545, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "routeType", "routeType", 55543, PropCategory.REGULAR)
