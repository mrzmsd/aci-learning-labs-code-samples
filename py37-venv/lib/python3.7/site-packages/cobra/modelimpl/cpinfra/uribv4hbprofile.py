...
# ##################################################
class Uribv4HBProfile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cpinfra.Uribv4HBProfile")

    meta.moClassName = "cpinfraUribv4HBProfile"
    meta.rnFormat = "uribv4hbt"
    meta.category = MoCategory.REGULAR
    meta.label = "Uribv4HBProfile"
