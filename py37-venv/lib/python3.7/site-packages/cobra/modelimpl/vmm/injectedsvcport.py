...
# ##################################################
class InjectedSvcPort(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.InjectedSvcPort")

    meta.moClassName = "vmmInjectedSvcPort"
    meta.rnFormat = "p-%(port)s-prot-%(protocol)s-t-%(targetPort)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Injected Service Port"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38731, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40870, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 34053, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "nodePort", "nodePort", 33761, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    ...
    prop = PropMeta("str", "port", "port", 33758, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "protocol", "protocol", 33759, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "targetPort", "targetPort", 33760, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
