...
# ##################################################
class VlifpTracker(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vmm.VlifpTracker")

    meta.moClassName = "vmmVlifpTracker"
    meta.rnFormat = "vlifp-[%(vlifpDn)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "VirtualLIfP tracker for vmmEpPD"
    ...
    prop = PropMeta("str", "vlifpDn", "vlifpDn", 55806, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
    meta.props.add("vlifpDn", prop)

    meta.namingProps.append(getattr(meta.props, "vlifpDn"))
    getattr(meta.props, "vlifpDn").needDelimiter = True
    ...
    def __init__(self, parentMoOrDn, vlifpDn, markDirty=True, **creationProps):
        namingVals = [vlifpDn]
