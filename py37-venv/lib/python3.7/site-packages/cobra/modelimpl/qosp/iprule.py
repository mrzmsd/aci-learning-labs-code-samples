...
class IpRule(Mo):
    ...
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("qosp:IpRuleaddr_failed_flag", None, 256)
    prop._addConstant("qosp:IpRuledescr_failed_flag", None, 4)
    prop._addConstant("qosp:IpRulelcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("qosp:IpRulemarkDot1P_failed_flag", None, 8)
    prop._addConstant("qosp:IpRulemarkDscp_failed_flag", None, 16)
    prop._addConstant("qosp:IpRulemodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("qosp:IpRulenameAlias_failed_flag", None, 2)
    prop._addConstant("qosp:IpRulename_failed_flag", None, 1)
    prop._addConstant("qosp:IpRuleqosGrp_failed_flag", None, 128)
