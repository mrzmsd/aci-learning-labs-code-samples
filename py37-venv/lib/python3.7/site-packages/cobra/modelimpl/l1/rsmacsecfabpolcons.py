...
# ##################################################
class RsMacsecFabPolCons(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.l1.RsMacsecFabPolCons", "cobra.model.macsec.FabIfPol")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "l1RsMacsecFabPolCons"
    meta.rnFormat = "rsmacsecFabPolCons"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "MACSEC Fab Policy Attachment"
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 33086, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 33083, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 33082, PropCategory.REGULAR)
