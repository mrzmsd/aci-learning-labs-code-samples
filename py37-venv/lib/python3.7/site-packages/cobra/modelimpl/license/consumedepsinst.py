...
# ##################################################
class ConsumedEPsInst(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.license.ConsumedEPsInst")

    meta.moClassName = "licenseConsumedEPsInst"
    ...
    prop = PropMeta("str", "consumerId", "consumerId", 53052, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "licenseCount", "licenseCount", 53054, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("licenseCount", prop)

    prop = PropMeta("str", "licenseType", "licenseType", 53053, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 4
