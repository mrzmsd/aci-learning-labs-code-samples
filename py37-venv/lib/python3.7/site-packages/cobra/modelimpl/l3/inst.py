...
class Inst(Mo):
    ...
    meta.readAccessMask = 0x709401002003
    ...
    meta.childClasses.add("cobra.model.tunnel.RlPodPfxEntry")
    ...
    meta.childClasses.add("cobra.model.tunnel.NatWhitelistPool")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.tunnel.RlPodPfxEntry", "rlpodpfx-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.tunnel.NatWhitelistPool", "natwl-"))
