...
# ##################################################
class ABgpPeerP(Mo):
    meta = ClassMeta("cobra.model.cloud.ABgpPeerP")

    meta.isAbstract = True
    meta.moClassName = "cloudABgpPeerP"


    meta.moClassName = "cloudABgpPeerP"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract BGP Peer Connectivity Profile"
    ...
    prop = PropMeta("str", "addr", "addr", 50100, PropCategory.REGULAR)
