...
# ##################################################
class IngressBytes1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.IngressBytes1mo", "cloud ingress bytess")
    ...
    meta.moClassName = "cloudIngressBytes1mo"
    meta.rnFormat = "CDcloudIngressBytes1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current cloud ingress bytess stats in 1 month"
