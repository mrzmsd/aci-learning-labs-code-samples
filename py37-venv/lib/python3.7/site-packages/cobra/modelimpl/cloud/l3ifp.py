...
class L3IfP(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.L3IfP")

    meta.moClassName = "cloudL3IfP"
    meta.rnFormat = "l3ifp"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Layer3 Interface Profile"
    ...
    meta.childClasses.add("cobra.model.cloud.BgpPeerP")
    meta.childClasses.add("cobra.model.cloud.OspfIfP")
    meta.childClasses.add("cobra.model.cloud.Ipv4AddrP")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.BgpPeerP", "bgppeerp-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.Ipv4AddrP", "ipv4addrp"))
    meta.childNamesAndRnPrefix.append(("cobra.model.aaa.RbacAnnotation", "rbacDom-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.OspfIfP", "ospfifp-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 51520, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51521, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
