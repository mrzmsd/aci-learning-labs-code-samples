...
# ##################################################
class EgressBytesAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesAgHist5min", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesAgHist5min"
    meta.rnFormat = "HDcloudEgressBytesAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated cloud egress bytes stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 50629, PropCategory.REGULAR)
