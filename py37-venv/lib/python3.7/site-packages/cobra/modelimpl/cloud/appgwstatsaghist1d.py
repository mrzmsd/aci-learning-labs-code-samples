...
# ##################################################
class AppGwStatsAgHist1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.AppGwStatsAgHist1d", "Azure ALB front end stats")
    ...
    meta.moClassName = "cloudAppGwStatsAgHist1d"
    meta.rnFormat = "HDcloudAppGwStatsAg1d-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated Azure ALB front end stats stats in 1 day"
    ...
    prop = PropMeta("str", "index", "index", 55353, PropCategory.REGULAR)
