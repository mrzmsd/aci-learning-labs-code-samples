...
# ##################################################
class AwsProvider(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.AwsProvider")

    meta.moClassName = "cloudAwsProvider"
    meta.rnFormat = "awsprovider"
    ...
    prop = PropMeta("str", "accessKeyId", "accessKeyId", 50163, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "accountId", "accountId", 52051, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 51566, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "email", "email", 51792, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51567, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "httpProxy", "httpProxy", 51793, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "isAccountInOrg", "isAccountInOrg", 52162, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "isTrusted", "isTrusted", 52053, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "region", "region", 50165, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "secretAccessKey", "secretAccessKey", 50164, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "shareableAcrossTenant", "shareableAcrossTenant", 53046, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "startGarbageCollector", "startGarbageCollector", 53881, PropCategory.REGULAR)
