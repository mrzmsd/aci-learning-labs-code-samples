...
# ##################################################
class AController(Mo):
    meta = ClassMeta("cobra.model.cloud.AController")

    meta.isAbstract = True
    meta.moClassName = "cloudAController"


    meta.moClassName = "cloudAController"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Controller Info"
    ...
    meta.concreteSubClasses.add("cobra.model.cloud.Controller")
    ...
    prop = PropMeta("str", "cidr", "cidr", 52847, PropCategory.REGULAR)
    prop.label = "Cidr"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "infraIp", "infraIp", 52849, PropCategory.REGULAR)
    prop.label = "Cloud Controller Infra IP"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("infraIp", prop)

    prop = PropMeta("str", "mgmtIp", "mgmtIp", 52848, PropCategory.REGULAR)
    prop.label = "Cloud Controller Mgmt IP"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("mgmtIp", prop)

    prop = PropMeta("str", "mgmtPublicIp", "mgmtPublicIp", 54179, PropCategory.REGULAR)
    prop.label = "Cloud Controller Mgmt Public IP"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("mgmtPublicIp", prop)

    prop = PropMeta("str", "provider", "provider", 52850, PropCategory.REGULAR)
    prop.label = "Cloud Provider"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "region", "region", 52851, PropCategory.REGULAR)
    prop.label = "Cloud Controller Region"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "regionDn", "regionDn", 55800, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "subnet", "subnet", 52846, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("subnet", prop)

    prop = PropMeta("str", "zone", "zone", 52852, PropCategory.REGULAR)
    prop.label = "Cloud Controller Zone"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "a"
    prop._addConstant("a", "a", 0)
    prop._addConstant("b", "b", 1)
