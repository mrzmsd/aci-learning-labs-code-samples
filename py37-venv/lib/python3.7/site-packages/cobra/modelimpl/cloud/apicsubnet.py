...
class ApicSubnet(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.ApicSubnet")

    meta.moClassName = "cloudApicSubnet"
    meta.rnFormat = "apicsubnet-[%(subnet)s]"
    meta.category = MoCategory.REGULAR
    meta.label = "Apic Subnet"
    ...
    meta.superClasses.add("cobra.model.cloud.AApicSubnet")

    meta.rnPrefixes = [
        ('apicsubnet-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 52868, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 52869, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "subnet", "subnet", 52860, PropCategory.REGULAR)
    prop.label = "Subnet"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
