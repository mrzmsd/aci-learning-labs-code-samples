...
# ##################################################
class EgressBytesHist1h(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.EgressBytesHist1h", "cloud egress bytes")
    ...
    meta.moClassName = "cloudEgressBytesHist1h"
    meta.rnFormat = "HDcloudEgressBytes1h-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical cloud egress bytes stats in 1 hour"
    ...
    prop = PropMeta("str", "index", "index", 50632, PropCategory.REGULAR)
