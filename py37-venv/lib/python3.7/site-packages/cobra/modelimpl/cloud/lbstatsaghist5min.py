...
# ##################################################
class LBStatsAgHist5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.cloud.LBStatsAgHist5min", "ALB front end stats")
    ...
    meta.moClassName = "cloudLBStatsAgHist5min"
    meta.rnFormat = "HDcloudLBStatsAg5min-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical aggregated ALB front end stats stats in 5 minute"
    ...
    prop = PropMeta("str", "index", "index", 52404, PropCategory.REGULAR)
