...
class Controller(Mo):
    ...
    meta = ClassMeta("cobra.model.cloud.Controller")

    meta.moClassName = "cloudController"
    meta.rnFormat = "controller"
    meta.category = MoCategory.REGULAR
    meta.label = "Controller info"
    ...
    meta.superClasses.add("cobra.model.cloud.AController")
