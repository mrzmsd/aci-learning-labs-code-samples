...
# ##################################################
class Ipv4AddrPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.Ipv4AddrPDef")

    meta.moClassName = "cloudIpv4AddrPDef"
    meta.rnFormat = "ipv4addrpd"
    meta.category = MoCategory.REGULAR
    meta.label = "Cloud Interface Ipv4 Address Profile Def"
