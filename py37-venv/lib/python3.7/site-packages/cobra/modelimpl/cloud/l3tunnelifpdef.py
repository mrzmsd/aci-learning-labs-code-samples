...
# ##################################################
class L3TunnelIfPDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.cloud.L3TunnelIfPDef")

    meta.moClassName = "cloudL3TunnelIfPDef"
    meta.rnFormat = "l3tunnelifpd-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "L3 Tunnel Interface Policy Def"
    ...
    meta.childClasses.add("cobra.model.cloud.IpSecTunnelIfPDef")
    meta.childClasses.add("cobra.model.cloud.L3IfPDef")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.cloud.IpSecTunnelIfPDef", "ipsectunnelifpd-"))
    ...
    prop = PropMeta("str", "name", "name", 50701, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
