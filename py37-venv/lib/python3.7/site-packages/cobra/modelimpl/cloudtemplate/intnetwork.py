...
class IntNetwork(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudtemplate.IntNetwork")

    meta.moClassName = "cloudtemplateIntNetwork"
    meta.rnFormat = "intnetwork-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Template for Internal Network"
    ...
    prop = PropMeta("str", "annotation", "annotation", 51728, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 51729, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 50722, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
