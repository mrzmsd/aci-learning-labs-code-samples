...
# ##################################################
class Node(Mo):
    meta = ClassMeta("cobra.model.hvs.Node")

    meta.isAbstract = True
    meta.moClassName = "hvsNode"
    ...
    prop = PropMeta("str", "oid", "oid", 197, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "type", "type", 196, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
