...
class AggrIf(Mo):
    ...
    meta = ClassMeta("cobra.model.edm.AggrIf")

    meta.moClassName = "edmAggrIf"
    meta.rnFormat = "aggr-%(pcId)s"
    ...
    meta.childClasses.add("cobra.model.edm.RsMbrIfs")

    meta.childNamesAndRnPrefix.append(("cobra.model.edm.RsMbrIfs", "rsmbrIfs-"))
    ...
    prop = PropMeta("str", "operSt", "operSt", 49759, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcId", "pcId", 49760, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "pcMode", "pcMode", 49761, PropCategory.REGULAR)
    ...
    meta.namingProps.append(getattr(meta.props, "pcId"))
    ...
    def __init__(self, parentMoOrDn, pcId, markDirty=True, **creationProps):
        namingVals = [pcId]
