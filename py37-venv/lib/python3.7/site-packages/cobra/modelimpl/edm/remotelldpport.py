...
# ##################################################
class RemoteLLDPPort(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.edm.RemoteLLDPPort")

    meta.moClassName = "edmRemoteLLDPPort"
    meta.rnFormat = "lldpAdj-%(sysName)s-%(mgmtId)s-%(portIdV)s"
    meta.category = MoCategory.REGULAR
    meta.label = "External Device LLDP RemotePath"
    ...
    prop = PropMeta("str", "capability", "capability", 49778, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "chassisIdT", "chassisIdT", 49771, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "chassisIdV", "chassisIdV", 49772, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "fabricPathDn", "fabricPathDn", 49783, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mgmtId", "mgmtId", 49781, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "mgmtIp", "mgmtIp", 49779, PropCategory.REGULAR)
    prop.label = "Management Address"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("mgmtIp", prop)

    prop = PropMeta("str", "mgmtPortMac", "mgmtPortMac", 49780, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portDesc", "portDesc", 49777, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portIdT", "portIdT", 49773, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portIdV", "portIdV", 49774, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "portVlan", "portVlan", 49782, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "sysName", "sysName", 49776, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ttl", "ttl", 49775, PropCategory.REGULAR)
    prop.label = "TTL"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    meta.namingProps.append(getattr(meta.props, "mgmtId"))
    meta.namingProps.append(getattr(meta.props, "portIdV"))
    ...
    def __init__(self, parentMoOrDn, sysName, mgmtId, portIdV, markDirty=True, **creationProps):
        namingVals = [sysName, mgmtId, portIdV]
