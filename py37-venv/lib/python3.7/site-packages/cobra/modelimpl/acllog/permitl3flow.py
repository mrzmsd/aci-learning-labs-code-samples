...
class PermitL3Flow(Mo):
    ...
    meta.rnFormat = "permitl3flow-spctag-%(srcPcTag)s-dpctag-%(dstPcTag)s-sepgname-%(srcEpgName)s-depgname-%(dstEpgName)s-sip-[%(srcIp)s]-dip-[%(dstIp)s]-proto-%(protocol)s-sport-%(srcPort)s-dport-%(dstPort)s-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-sintf-[%(srcIntf)s]-vrfencap-%(vrfEncap)s"
    ...
    prop = PropMeta("str", "dstEpgName", "dstEpgName", 37095, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstPcTag", "dstPcTag", 37096, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcEpgName", "srcEpgName", 37097, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPcTag", "srcPcTag", 37098, PropCategory.REGULAR)
