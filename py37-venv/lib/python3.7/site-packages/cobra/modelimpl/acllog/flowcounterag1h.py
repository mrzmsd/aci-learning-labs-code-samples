...
class FlowCounterAg1h(Mo):
    """
    A class that represents the most current aggregated statistics for  Flow  Record  Counter in a 1 hour sampling interval.  This class updates every 15 minutes.
