...
class PermitL2Flow(Mo):
    ...
    meta.rnFormat = "permitl2flow-spctag-%(srcPcTag)s-dpctag-%(dstPcTag)s-sepgname-%(srcEpgName)s-depgname-%(dstEpgName)s-smac-%(srcMacAddr)s-dmac-%(dstMacAddr)s-sintf-[%(srcIntf)s]-vlan-%(vlan)s"
    ...
    prop = PropMeta("str", "dstEpgName", "dstEpgName", 37091, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "dstPcTag", "dstPcTag", 37092, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcEpgName", "srcEpgName", 37093, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcPcTag", "srcPcTag", 37094, PropCategory.REGULAR)
