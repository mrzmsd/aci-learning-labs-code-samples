...
# ##################################################
class RtTgToEndPoint(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcloud.RtTgToEndPoint", "cobra.model.hcloud.TargetGroup")

    meta.moClassName = "hcloudRtTgToEndPoint"
    meta.rnFormat = "rttgToEndPoint-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 51949, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54681, PropCategory.REGULAR)
