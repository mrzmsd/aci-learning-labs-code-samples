...
class Instance(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Instance")

    meta.moClassName = "hcloudInstance"
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsInstToScaleSet", "rsinstToScaleSet"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtEpToInst", "rtepToInst-"))
    ...
    prop = PropMeta("str", "imageId", "imageId", 53884, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 50750, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "tag", "tag", 50310, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
