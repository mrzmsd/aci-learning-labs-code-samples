...
class RuleAction(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.RuleAction")

    meta.moClassName = "hcloudRuleAction"
    meta.rnFormat = "action-%(actionType)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Native Service Listener Rule Action"
    ...
    meta.childClasses.add("cobra.model.hcloud.RsActionToTargetGroup")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsActionToTargetGroup", "rsactionToTargetGroup"))
    ...
    meta.superClasses.add("cobra.model.hcloud.AAction")

    meta.rnPrefixes = [
        ('action-', True),
    ]

    prop = PropMeta("str", "actionType", "actionType", 51896, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    meta.props.add("actionType", prop)
    ...
    prop = PropMeta("str", "contentType", "contentType", 51860, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("contentType", prop)
    ...
    prop = PropMeta("str", "host", "host", 51854, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "message", "message", 51859, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "path", "path", 51855, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "port", "port", 51853, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "protocol", "protocol", 51852, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "query", "query", 51856, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("query", prop)

    prop = PropMeta("str", "redirectCode", "redirectCode", 51857, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "responseCode", "responseCode", 51858, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    meta.namingProps.append(getattr(meta.props, "actionType"))
    ...
    def __init__(self, parentMoOrDn, actionType, markDirty=True, **creationProps):
        namingVals = [actionType]
