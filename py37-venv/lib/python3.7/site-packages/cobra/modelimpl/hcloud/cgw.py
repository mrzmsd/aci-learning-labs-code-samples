...
class Cgw(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Cgw")

    meta.moClassName = "hcloudCgw"
    meta.rnFormat = "cgw-[%(addr)s]"
    ...
    meta.childClasses.add("cobra.model.hcloud.RtVpnConnToCgw")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtVpnConnToCgw", "rtvpnConnToCgw"))
    ...
    prop = PropMeta("str", "addr", "addr", 50401, PropCategory.REGULAR)
    prop.label = "IP Address of the Customer Gateway"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "asn", "asn", 50399, PropCategory.REGULAR)
    prop.label = "Autonomous System Number of the Customer's GW"
    ...
    prop = PropMeta("str", "connectionType", "connectionType", 50400, PropCategory.REGULAR)
    prop.label = "Type of VPN Connection"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "networkInterfaceDn", "networkInterfaceDn", 54951, PropCategory.REGULAR)
    prop.label = "DN of the CSR internal network interface this CGW represent"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("networkInterfaceDn", prop)
