...
class CertStore(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.CertStore")

    meta.moClassName = "hcloudCertStore"
    meta.rnFormat = "certstore-%(store)s"
    ...
    meta.childClasses.add("cobra.model.hcloud.Certificate")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.Certificate", "cert-"))
    ...
    prop = PropMeta("str", "store", "store", 52891, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    meta.props.add("store", prop)

    meta.namingProps.append(getattr(meta.props, "store"))
    ...
    def __init__(self, parentMoOrDn, store, markDirty=True, **creationProps):
        namingVals = [store]
