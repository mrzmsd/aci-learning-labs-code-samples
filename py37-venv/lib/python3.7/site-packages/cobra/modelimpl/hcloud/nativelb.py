...
class NativeLB(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.NativeLB")

    meta.moClassName = "hcloudNativeLB"
    meta.rnFormat = "nativeLB-[%(name)s]-oid-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.hcloud.ALbStats")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.health.Inst")
    meta.childClasses.add("cobra.model.hcloud.Listener")
    meta.childClasses.add("cobra.model.hcloud.IpOper")
    meta.childClasses.add("cobra.model.hcloud.TargetGroup")
    ...
    meta.childClasses.add("cobra.model.hcloud.RsLBToSecurityGroup")
    meta.childClasses.add("cobra.model.hcloud.RtSelectorToTagParent")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.hcloud.RsLBToSubnet")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsLBToSecurityGroup", "rslBToSecurityGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsLBToSubnet", "rslBToSubnet-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.ALbStats", "albstats-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.Listener", "listener-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.TargetGroup", "tGroup-"))
    ...
    meta.superClasses.add("cobra.model.hcloud.AhcloudDev")
    ...
    prop = PropMeta("str", "delegateDn", "delegateDn", 54188, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "instanceCount", "instanceCount", 54950, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("instanceCount", prop)

    prop = PropMeta("str", "ipAddrType", "ipAddrType", 51843, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    meta.props.add("ipAddrType", prop)

    prop = PropMeta("str", "lbType", "lbType", 51844, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "logicalMoDn", "logicalMoDn", 52890, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 51895, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "oid", "oid", 52365, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "scheme", "scheme", 51842, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "size", "size", 54949, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    def __init__(self, parentMoOrDn, name, oid, markDirty=True, **creationProps):
        namingVals = [name, oid]
