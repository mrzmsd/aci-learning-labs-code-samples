...
# ##################################################
class ASgRule(Mo):
    meta = ClassMeta("cobra.model.hcloud.ASgRule")

    meta.isAbstract = True
    meta.moClassName = "hcloudASgRule"
    ...
    prop = PropMeta("str", "fromPort", "fromPort", 52877, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpCode", "icmpCode", 52881, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpv4Type", "icmpv4Type", 52879, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "icmpv6Type", "icmpv6Type", 52880, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "protocol", "protocol", 52876, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "toPort", "toPort", 52878, PropCategory.REGULAR)
