...
class ProvAcctGC(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.ProvAcctGC")

    meta.moClassName = "hcloudProvAcctGC"
    meta.rnFormat = "gcpol"
    ...
    prop = PropMeta("str", "interval", "interval", 55851, PropCategory.REGULAR)
    prop.label = "Time interval in seconds after which stale resources will be deleted"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "mode", "mode", 55982, PropCategory.REGULAR)
