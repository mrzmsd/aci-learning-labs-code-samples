...
class Igw(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.Igw")

    meta.moClassName = "hcloudIgw"
    meta.rnFormat = "igw"
    ...
    meta.childClasses.add("cobra.model.hcloud.RtNextHopToIgw")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtNextHopToIgw", "rtnextHopToIgw-"))
