...
class TargetGroup(Mo):
    ...
    meta = ClassMeta("cobra.model.hcloud.TargetGroup")

    meta.moClassName = "hcloudTargetGroup"
    meta.rnFormat = "tGroup-[%(name)s]-oid-%(oid)s"
    ...
    meta.childClasses.add("cobra.model.hcloud.TgStats")
    meta.childClasses.add("cobra.model.hcloud.RsTgToSecurityGroup")
    meta.childClasses.add("cobra.model.hcloud.TargetOper")
    meta.childClasses.add("cobra.model.hcloud.RsTgToEndPoint")
    ...
    meta.childClasses.add("cobra.model.hcloud.RtActionToTargetGroup")
    meta.childClasses.add("cobra.model.fault.Delegate")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtSelectorToTagParent", "rtselectorToTagParent-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RtActionToTargetGroup", "rtactionToTargetGroup-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsTgToSecurityGroup", "rstgToSecurityGroup"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.RsTgToEndPoint", "rstgToEndPoint-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.hcloud.TgStats", "tgstats"))
    ...
    prop = PropMeta("str", "instanceType", "instanceType", 51863, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    prop.defaultValueStr = "ip"
    prop._addConstant("instance", "instance", 1)
    prop._addConstant("ip", "ip", 0)
    meta.props.add("instanceType", prop)

    prop = PropMeta("str", "lbOid", "lbOid", 53278, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("lbOid", prop)
    ...
    prop = PropMeta("str", "logicalMoDn", "logicalMoDn", 54189, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 51898, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "oid", "oid", 52366, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "port", "port", 51861, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("port", prop)

    prop = PropMeta("str", "protocol", "protocol", 51862, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
