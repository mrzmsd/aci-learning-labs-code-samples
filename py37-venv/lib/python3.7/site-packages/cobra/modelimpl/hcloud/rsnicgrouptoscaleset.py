...
# ##################################################
class RsNicGroupToScaleSet(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.hcloud.RsNicGroupToScaleSet", "cobra.model.hcloud.ScaleSet")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "hcloudRsNicGroupToScaleSet"
    meta.rnFormat = "rsnicGroupToScaleSet"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "nicgroup-to-scaleset"
    ...
    meta.rnPrefixes = [
        ('rsnicGroupToScaleSet', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 55718, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 55719, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "tCl", "tCl", 55711, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 55710, PropCategory.REGULAR)
