...
# ##################################################
class InputOtherErrorsHist1w(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.fc.InputOtherErrorsHist1w", "input other errors")
    ...
    meta.moClassName = "fcInputOtherErrorsHist1w"
    meta.rnFormat = "HDfcInputOtherErrors1w-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical input other errors stats in 1 week"
    ...
    prop = PropMeta("str", "index", "index", 42813, PropCategory.REGULAR)
