...
# ##################################################
class RtSnoopAccessGroupFilterRMap(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.pim.RtSnoopAccessGroupFilterRMap", "cobra.model.igmp.SnoopAccessGroup")

    meta.moClassName = "pimRtSnoopAccessGroupFilterRMap"
    meta.rnFormat = "rtigmpSnoopAccessGroupFilterRMap-[%(tDn)s]"
    ...
    meta.rnPrefixes = [
        ('rtigmpSnoopAccessGroupFilterRMap-', True),
    ]
    ...
    prop = PropMeta("str", "tCl", "tCl", 27435, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9249
    prop.defaultValueStr = "igmpSnoopAccessGroup"
    prop._addConstant("igmpSnoopAccessGroup", None, 9249)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 27434, PropCategory.REGULAR)
