...
class CtxPol(Mo):
    ...
    meta.childClasses.add("cobra.model.bgp.RtBgpNodeCtxPol")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.bgp.RtBgpNodeCtxPol", "rtbgpNodeCtxPol-"))
    ...
    prop = PropMeta("str", "annotation", "annotation", 37379, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39518, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 13903, PropCategory.REGULAR)
