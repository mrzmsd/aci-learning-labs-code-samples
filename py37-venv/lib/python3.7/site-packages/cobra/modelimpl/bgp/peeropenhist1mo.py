...
# ##################################################
class PeerOpenHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerOpenHist1mo", "BGP Peer Open")
    ...
    meta.moClassName = "bgpPeerOpenHist1mo"
    meta.rnFormat = "HDbgpPeerOpen1mo-%(index)s"
    ...
    prop = PropMeta("str", "index", "index", 47732, PropCategory.REGULAR)
