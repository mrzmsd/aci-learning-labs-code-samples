...
# ##################################################
class BgpPeerKeepAlive5min(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpPeerKeepAlive5min", "BGP Peer Keepalive")
    ...
    meta.moClassName = "bgpBgpPeerKeepAlive5min"
    meta.rnFormat = "CDbgpBgpPeerKeepAlive5min"
    ...
    meta.rnPrefixes = [
        ('CDbgpBgpPeerKeepAlive5min', False),
    ]
