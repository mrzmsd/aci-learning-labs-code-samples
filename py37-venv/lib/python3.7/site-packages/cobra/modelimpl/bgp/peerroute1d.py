...
# ##################################################
class PeerRoute1d(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.PeerRoute1d", "BGP Peer Route")
    ...
    meta.moClassName = "bgpPeerRoute1d"
    meta.rnFormat = "CDbgpPeerRoute1d"
