...
class RtP(Mo):
    ...
    meta = ClassMeta("cobra.model.bgp.RtP")

    meta.moClassName = "bgpRtP"
    ...
    meta.parentClasses.add("cobra.model.bgp.Vni")
    ...
    prop = PropMeta("str", "type", "type", 20705, PropCategory.REGULAR)
    prop.label = "Type"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
