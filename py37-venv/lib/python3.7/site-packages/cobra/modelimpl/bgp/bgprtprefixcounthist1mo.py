...
# ##################################################
class BgpRtPrefixCountHist1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.bgp.BgpRtPrefixCountHist1mo", "BGP Route Prefix Count")
    ...
    meta.moClassName = "bgpBgpRtPrefixCountHist1mo"
    meta.rnFormat = "HDbgpBgpRtPrefixCount1mo-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical BGP Route Prefix Count stats in 1 month"
    ...
    prop = PropMeta("str", "index", "index", 53423, PropCategory.REGULAR)
