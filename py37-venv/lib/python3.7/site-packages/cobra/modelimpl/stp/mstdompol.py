...
class MstDomPol(Mo):
    ...
    prop = PropMeta("str", "annotation", "annotation", 37351, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39490, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 22452, PropCategory.REGULAR)
