...
# ##################################################
class RtIkev2Profile(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.hcisakmp.RtIkev2Profile", "cobra.model.hctunn.If")

    meta.moClassName = "hcisakmpRtIkev2Profile"
    meta.rnFormat = "rthctunnIkev2Profile-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 54991, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 54990, PropCategory.REGULAR)
