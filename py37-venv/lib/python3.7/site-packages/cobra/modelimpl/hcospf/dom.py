...
class Dom(Mo):
    ...
    meta = ClassMeta("cobra.model.hcospf.Dom")

    meta.moClassName = "hcospfDom"
    ...
    meta.childClasses.add("cobra.model.hcospf.RsTunnIf")
    meta.childClasses.add("cobra.model.fault.Counts")
    meta.childClasses.add("cobra.model.hcospf.Area")
    meta.childClasses.add("cobra.model.hcospf.RsLoopbackIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.hcospf.RsLoopbackIf", "rsloopbackIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcospf.RsTunnIf", "rstunnIf-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.fault.Counts", "fltCnts"))
    meta.childNamesAndRnPrefix.append(("cobra.model.health.Inst", "health"))
    meta.childNamesAndRnPrefix.append(("cobra.model.hcospf.Area", "area-"))
    ...
    meta.superClasses.add("cobra.model.hcospf.ADom")
    ...
    prop = PropMeta("str", "ctrl", "ctrl", 50434, PropCategory.REGULAR)
    prop.label = "Controls"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "dist", "dist", 50435, PropCategory.REGULAR)
    prop.label = "Distance"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
    ...
    prop = PropMeta("str", "maxEcmp", "maxEcmp", 50436, PropCategory.REGULAR)
    prop.label = "Max ECMP"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 64)]
    ...
    prop = PropMeta("str", "name", "name", 50764, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "rtrId", "rtrId", 50433, PropCategory.REGULAR)
