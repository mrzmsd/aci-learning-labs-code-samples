...
class Filter(Mo):
    ...
    meta.rnFormat = "filter-%(action)s-prio-%(prio)s-proto-%(ipProto)s-src-[%(srcAddr)s]-dst-[%(dstAddr)s]-srcFromP-%(srcPortFrom)s-srcToP-%(srcPortTo)s-dstFromP-%(dstPortFrom)s-dstToP-%(dstPortTo)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38674, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "createdBy", "createdBy", 34483, PropCategory.REGULAR)
    prop.label = "Reference to the MO that created this filter"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40813, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop._addConstant("hardware-unsupported", "hardware-not-supported", 4)
    prop._addConstant("invalid-config", "invalid-config", 5)
    ...
    prop._addConstant("copp:Filterannotation_failed_flag", None, 2)
    prop._addConstant("copp:FiltercreatedBy_failed_flag", None, 4)
    prop._addConstant("copp:FilterdstAddr_failed_flag", None, 8)
    prop._addConstant("copp:FilterdstPortFrom_failed_flag", None, 16)
    prop._addConstant("copp:FilterdstPortTo_failed_flag", None, 32)
    prop._addConstant("copp:FilterextMngdBy_failed_flag", None, 64)
    prop._addConstant("copp:FilteripProto_failed_flag", None, 128)
    ...
    prop._addConstant("copp:FiltermonPolDn_failed_flag", None, 256)
    prop._addConstant("copp:Filterprio_failed_flag", None, 2048)
    prop._addConstant("copp:FiltersrcAddr_failed_flag", None, 32768)
    prop._addConstant("copp:FiltersrcPortFrom_failed_flag", None, 65536)
    prop._addConstant("copp:FiltersrcPortTo_failed_flag", None, 131072)
    ...
    def __init__(self, parentMoOrDn, action, prio, ipProto, srcAddr, dstAddr, srcPortFrom, srcPortTo, dstPortFrom, dstPortTo, markDirty=True, **creationProps):
        namingVals = [action, prio, ipProto, srcAddr, dstAddr, srcPortFrom, srcPortTo, dstPortFrom, dstPortTo]
