...
class Cdrom(Mo):
    ...
    meta = ClassMeta("cobra.model.comp.Cdrom")

    meta.moClassName = "compCdrom"
    meta.rnFormat = "cdrom-%(key)s"
    ...
    prop = PropMeta("str", "DeviceBackingInfo", "DeviceBackingInfo", 42676, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("DeviceBackingInfo", prop)
    ...
    prop = PropMeta("str", "controllerKey", "controllerKey", 42675, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "key", "key", 42674, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "label", "label", 42673, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
