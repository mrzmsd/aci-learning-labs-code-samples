...
class Hv(Mo):
    ...
    meta.childClasses.add("cobra.model.comp.RsHvCluster")
    ...
    meta.childClasses.add("cobra.model.comp.RtHvGroupToHv")
    ...
    meta.childClasses.add("cobra.model.comp.RtHvGroupDefToHv")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHvGroupDefToHv", "rthvGroupDefToHv-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RtHvGroupToHv", "rthvGroupToHv-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.comp.RsHvCluster", "rshvCluster"))
