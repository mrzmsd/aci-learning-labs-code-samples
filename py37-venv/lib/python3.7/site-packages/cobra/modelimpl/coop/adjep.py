...
class AdjEp(Mo):
    ...
    prop = PropMeta("str", "identity", "identity", 52982, PropCategory.REGULAR)
    prop.label = "Identity"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("identity", prop)
    ...
    prop = PropMeta("str", "tcpConnStatus", "tcpConnStatus", 55983, PropCategory.REGULAR)
    prop.label = "TCP Connection status"
    prop.isOper = True
    prop.defaultValue = 1
    prop.defaultValueStr = "down"
    prop._addConstant("down", "down", 1)
    prop._addConstant("up", "up", 2)
    meta.props.add("tcpConnStatus", prop)
