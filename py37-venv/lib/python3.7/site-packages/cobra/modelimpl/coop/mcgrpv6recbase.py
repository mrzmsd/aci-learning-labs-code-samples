...
# ##################################################
class McGrpv6RecBase(Mo):
    meta = ClassMeta("cobra.model.coop.McGrpv6RecBase")

    meta.isAbstract = True
    meta.moClassName = "coopMcGrpv6RecBase"
    ...
    prop = PropMeta("str", "mcGrpIp", "mcGrpIp", 20634, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "srcIp", "srcIp", 20633, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "version", "version", 20632, PropCategory.REGULAR)
    prop.label = "Version"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 3)]
