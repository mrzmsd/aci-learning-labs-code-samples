...
class Out(Mo):
    ...
    meta.readAccessMask = 0x6000400401803701
    ...
    prop = PropMeta("str", "annotation", "annotation", 37597, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 39736, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
