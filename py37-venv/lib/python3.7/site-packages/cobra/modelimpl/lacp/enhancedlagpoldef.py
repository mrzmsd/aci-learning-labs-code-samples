...
# ##################################################
class EnhancedLagPolDef(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.lacp.EnhancedLagPolDef")

    meta.moClassName = "lacpEnhancedLagPolDef"
    meta.rnFormat = "enlagPD-%(name)s"
    ...
    meta.childClasses.add("cobra.model.lacp.RtEnhancedLagPol")

    meta.childNamesAndRnPrefix.append(("cobra.model.lacp.RtEnhancedLagPol", "rthvsEnhancedLagPol-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 44376, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 44365, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
