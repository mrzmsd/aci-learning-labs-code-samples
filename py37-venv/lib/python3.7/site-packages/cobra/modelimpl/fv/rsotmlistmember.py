...
# ##################################################
class RsOtmListMember(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fv.RsOtmListMember", "cobra.model.fv.TrackMember")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fvRsOtmListMember"
    meta.rnFormat = "rsotmListMember-[%(tDn)s]"
    ...
    meta.childClasses.add("cobra.model.fv.RtTrackListReln")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.fv.RtTrackListReln", "rtpolTrackListReln-"))
    ...
    meta.rnPrefixes = [
        ('rsotmListMember-', True),
    ]

    prop = PropMeta("str", "annotation", "annotation", 45673, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 45674, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45667, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 45659, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45658, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "weight", "weight", 47400, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(1, 255)]
