...
# ##################################################
class RtNexthopRouteTrack(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = TargetRelationMeta("cobra.model.fv.RtNexthopRouteTrack", "cobra.model.ip.NexthopP")

    meta.moClassName = "fvRtNexthopRouteTrack"
    meta.rnFormat = "rtipNexthopRouteTrack-[%(tDn)s]"
    ...
    prop = PropMeta("str", "tCl", "tCl", 45709, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45708, PropCategory.REGULAR)
