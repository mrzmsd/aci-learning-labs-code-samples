...
class KeyPol(Mo):
    ...
    meta = ClassMeta("cobra.model.fv.KeyPol")

    meta.moClassName = "fvKeyPol"
    meta.rnFormat = "keyp-%(id)s"
    ...
    prop = PropMeta("str", "annotation", "annotation", 49930, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 49931, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 49910, PropCategory.REGULAR)
    prop.label = "Key Id"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 49923, PropCategory.REGULAR)
