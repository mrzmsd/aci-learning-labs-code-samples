...
# ##################################################
class RsNetflowNodePol(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = NamedSourceRelationMeta("cobra.model.infra.RsNetflowNodePol", "cobra.model.netflow.NodePol")
    meta.targetNameProps["name"] = "tnNetflowNodePolName"
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "infraRsNetflowNodePol"
    meta.rnFormat = "rsnetflowNodePol"
    ...
    meta.rnPrefixes = [
        ('rsnetflowNodePol', False),
    ]

    prop = PropMeta("str", "annotation", "annotation", 38553, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40692, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27397, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 27360, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tnNetflowNodePolName", "tnNetflowNodePolName", 27359, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    meta.props.add("tnNetflowNodePolName", prop)
