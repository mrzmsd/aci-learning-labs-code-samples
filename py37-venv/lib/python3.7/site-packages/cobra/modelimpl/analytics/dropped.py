...
# ##################################################
class Dropped(Mo):
    meta = StatsClassMeta("cobra.model.analytics.Dropped", "Netflow Drop Counters")
    ...
    meta.moClassName = "analyticsDropped"


    meta.moClassName = "analyticsDropped"
    meta.rnFormat = ""
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current Netflow Drop Counters stats"
