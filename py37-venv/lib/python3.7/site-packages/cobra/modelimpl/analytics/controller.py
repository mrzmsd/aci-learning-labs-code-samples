...
class Controller(Mo):
    ...
    meta = ClassMeta("cobra.model.analytics.Controller")

    meta.moClassName = "analyticsController"
    meta.rnFormat = "controller-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Controller Reachability"
    ...
    prop = PropMeta("str", "InstallOperSt", "InstallOperSt", 27787, PropCategory.REGULAR)
    prop.label = "Image Installation Operational State"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    meta.props.add("InstallOperSt", prop)

    prop = PropMeta("str", "InstallOperStQual", "InstallOperStQual", 27788, PropCategory.REGULAR)
    prop.label = "Image Installation Operational State Qualifier"
    prop.isOper = True
    prop.defaultValue = 0
    prop.defaultValueStr = "unspecified"
    prop._addConstant("downloaded", "image-downloaded-successfully", 3)
    prop._addConstant("failed", "image-installation-failed", 4)
    prop._addConstant("installed", "image-installation-successful", 5)
    prop._addConstant("not-found", "image-install-uri-not-found", 2)
    prop._addConstant("unreachable", "image-install-uri-unreachable", 1)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("InstallOperStQual", prop)

    prop = PropMeta("str", "annotation", "annotation", 38512, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40651, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "imageUri", "imageUri", 27719, PropCategory.REGULAR)
    prop.label = "Image URI"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("imageUri", prop)

    prop = PropMeta("str", "imageUri2", "imageUri2", 33117, PropCategory.REGULAR)
    prop.label = "Image URI2"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("imageUri2", prop)

    prop = PropMeta("str", "imageVer", "imageVer", 27805, PropCategory.REGULAR)
    prop.label = "Image Version"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    meta.props.add("imageVer", prop)
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27014, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "name", "name", 26181, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
