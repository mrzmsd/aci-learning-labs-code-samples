...
# ##################################################
class RsRecordPAtt(Mo):
    """
     Relation to record 

    """

    meta = SourceRelationMeta("cobra.model.analytics.RsRecordPAtt", "cobra.model.analytics.RecordP")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "analyticsRsRecordPAtt"
    meta.rnFormat = "rsrecordPAtt"
    ...
    prop = PropMeta("str", "annotation", "annotation", 38515, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40654, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26201, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "nfmCfgFailedBmp", "nfmCfgFailedBmp", 30061, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("analytics:RsRecordPAttannotation_failed_flag", None, 128)
    prop._addConstant("analytics:RsRecordPAttextMngdBy_failed_flag", None, 256)
    prop._addConstant("analytics:RsRecordPAttforceResolve_failed_flag", None, 4)
    prop._addConstant("analytics:RsRecordPAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("analytics:RsRecordPAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("analytics:RsRecordPAttmonPolDn_failed_flag", None, 512)
    prop._addConstant("analytics:RsRecordPAttrType_failed_flag", None, 8)
    prop._addConstant("analytics:RsRecordPAttstateQual_failed_flag", None, 32)
    prop._addConstant("analytics:RsRecordPAttstate_failed_flag", None, 16)
    prop._addConstant("analytics:RsRecordPAtttCl_failed_flag", None, 1)
    prop._addConstant("analytics:RsRecordPAtttDn_failed_flag", None, 2)
    prop._addConstant("analytics:RsRecordPAtttType_failed_flag", None, 64)
    prop._addConstant("analytics:RsRecordPAttuid_failed_flag", None, 4611686018427387904)
    meta.props.add("nfmCfgFailedBmp", prop)

    prop = PropMeta("str", "nfmCfgFailedTs", "nfmCfgFailedTs", 30063, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("nfmCfgFailedTs", prop)

    prop = PropMeta("str", "nfmCfgState", "nfmCfgState", 30062, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("nfmCfgState", prop)

    prop = PropMeta("str", "operSt", "operSt", 30059, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 30060, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 26185, PropCategory.REGULAR)
    prop.label = "Target-class"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 9020
    prop.defaultValueStr = "analyticsRecordP"
    prop._addConstant("analyticsRecordP", None, 9020)
    prop._addConstant("unspecified", "unspecified", 0)
    meta.props.add("tCl", prop)

    prop = PropMeta("str", "tDn", "tDn", 26184, PropCategory.REGULAR)
