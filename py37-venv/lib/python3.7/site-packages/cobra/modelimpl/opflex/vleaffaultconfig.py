...
# ##################################################
class VleafFaultConfig(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.opflex.VleafFaultConfig")

    meta.moClassName = "opflexVleafFaultConfig"
    meta.rnFormat = "vleaffault-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Concrete class to collect vleaf issues from AVS"
    ...
    prop = PropMeta("str", "handle", "handle", 25481, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "name", "name", 25566, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
