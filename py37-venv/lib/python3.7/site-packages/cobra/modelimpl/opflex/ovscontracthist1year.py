...
# ##################################################
class OvsContractHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.opflex.OvsContractHist1year", "ovs contract stats")
    ...
    meta.moClassName = "opflexOvsContractHist1year"
    meta.rnFormat = "HDopflexOvsContract1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical ovs contract stats stats in 1 year"
    ...
    prop = PropMeta("str", "index", "index", 34758, PropCategory.REGULAR)
