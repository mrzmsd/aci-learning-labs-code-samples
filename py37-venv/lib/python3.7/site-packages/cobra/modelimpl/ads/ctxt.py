...
class Ctxt(Mo):
    ...
    meta = ClassMeta("cobra.model.ads.Ctxt")

    meta.moClassName = "adsCtxt"
    meta.rnFormat = "ctxt"
    meta.category = MoCategory.REGULAR
    meta.label = "ads Context"
    ...
    prop = PropMeta("str", "ctrlrDn", "ctrlrDn", 43638, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "replicaId", "replicaId", 43640, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "runId", "runId", 43644, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("runId", prop)

    prop = PropMeta("str", "shardId", "shardId", 43639, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
    ...
    prop = PropMeta("str", "trigDn", "trigDn", 43642, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("trigDn", prop)

    prop = PropMeta("str", "trigId", "trigId", 43643, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("trigId", prop)

    prop = PropMeta("str", "trigT", "trigT", 43641, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
