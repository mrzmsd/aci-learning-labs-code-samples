...
class SnoopPol(Mo):
    ...
    meta = ClassMeta("cobra.model.mld.SnoopPol")

    meta.moClassName = "mldSnoopPol"
    meta.rnFormat = "mldsnoopPol-%(name)s"
    ...
    meta.childClasses.add("cobra.model.mld.RtMldsn")
    meta.childClasses.add("cobra.model.fault.Delegate")
    meta.childClasses.add("cobra.model.aaa.RbacAnnotation")
    meta.childClasses.add("cobra.model.tag.Annotation")

    meta.childNamesAndRnPrefix.append(("cobra.model.tag.Annotation", "annotationKey-"))
    meta.childNamesAndRnPrefix.append(("cobra.model.mld.RtMldsn", "rtfvMldsn-"))
    ...
    prop = PropMeta("str", "adminSt", "adminSt", 49947, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "annotation", "annotation", 47385, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 47386, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "name", "name", 47372, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
