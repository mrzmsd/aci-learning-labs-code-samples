...
class FabricTarget(Mo):
    ...
    prop._addConstant("aaaCtrlrFipsState", "controller-fips-state-(aaa.ctrlrfipsstate)", 9413)
    prop._addConstant("aaaDomainRef", "reference-to-domain-tag-for-parent-object-(aaa.domainref)", 1562)
    prop._addConstant("aaaDuoEp", "duo-authentication-settings-(aaa.duoep)", 16429)
    ...
    prop._addConstant("actrlStatsReport", "statistics-(actrl.statsreport)", 15622)
    prop._addConstant("aibEntity", "adjacency-information-base-entity-(aib.entity)", 3552)
    ...
    prop._addConstant("analyticsRsRecordSsxAtt", "record-ssx-policy-attachment-(analytics.rsrecordssxatt)", 16195)
    ...
    prop._addConstant("bgpPeerEntryStats", "peer-entry-statistics-(bgp.peerentrystats)", 2607)
    ...
    prop._addConstant("cloudBgpAsP", "autonomous-system-profile-(cloud.bgpasp)", 14396)
    ...
    prop._addConstant("cloudDomP", "cloud-domain-profile-(cloud.domp)", 14654)
    prop._addConstant("cloudHealthTotal", "cloud-health-score-(cloud.healthtotal)", 15805)
    ...
    prop._addConstant("cloudProvP", "cloud-provider-profile-(cloud.provp)", 14657)
    prop._addConstant("cloudRegion", "cloud-provider-region-(cloud.region)", 14804)
    prop._addConstant("cloudResourceGroup", "resource-group-for-cloud-policies-(cloud.resourcegroup)", 16108)
    ...
    prop._addConstant("cloudSvcDefCont", "cloud-service-container-for-resolved-data-(cloud.svcdefcont)", 15158)
    prop._addConstant("cloudSvcPolicyDef", "resolved-cloud-load-balancer-policy-(cloud.svcpolicydef)", 15184)
    prop._addConstant("cloudTenantSvcDef", "cloud-service-container-for-tenant-resolved-data-(cloud.tenantsvcdef)", 15159)
    ...
    prop._addConstant("commApiAvgRespTime", "response-time-non-configurable-(comm.apiavgresptime)", 16066)
    ...
    prop._addConstant("datetimeRsNtpProvToNtpIFFClientKey", "relation-to-datetime-secure-session-key-(datetime.rsntpprovtontpiffclientkey)", 15617)
    ...
    prop._addConstant("dnsConfIssues", "dns-profile-policy-configuration-issues-(dns.confissues)", 15748)
    prop._addConstant("dnsProfile", "dns-profile-(dns.profile)", 278)
    ...
    prop._addConstant("extdevAssociatedAppsCont", "container-for-app-links-(extdev.associatedappscont)", 15312)
    prop._addConstant("extdevDomainCont", "container-for-domain-relations-(extdev.domaincont)", 12676)
    prop._addConstant("extdevGroupP", "integration-group-(extdev.groupp)", 12672)
    prop._addConstant("extdevMgrP", "integration-(extdev.mgrp)", 12673)
    ...
    prop._addConstant("extdevRsFromDevMgrToApp", "relation-to-app-(extdev.rsfromdevmgrtoapp)", 15313)
    prop._addConstant("extdevRsNicProfToDomP", "relation-to-domp-(extdev.rsnicproftodomp)", 12681)
    prop._addConstant("extdevSwMgrFlags", "container-for-domain-relations-(extdev.swmgrflags)", 14384)
    prop._addConstant("extdevSwMgrPolCont", "container-for-domain-relations-(extdev.swmgrpolcont)", 14383)
    ...
    prop._addConstant("fabricCreatedBy", "created-by-(fabric.createdby)", 867)
    ...
    prop._addConstant("fabricExtSetupP", "fabric-setup-policy-for-an-external-site-(fabric.extsetupp)", 11015)
    prop._addConstant("fabricFuncP", "function-profile-(fabric.funcp)", 890)
    prop._addConstant("fabricGroupRef", "reference-of-group-of-ports-connected-to-external-connected-node-(fabric.groupref)", 501)
    ...
    prop._addConstant("fabricRsApplTechSupOnDemand", "tech-support-policy-for-on-demand-collection-(fabric.rsappltechsupondemand)", 15798)
    ...
    prop._addConstant("infraRsEquipmentFlashConfigPol", "flash-configuration-policy-(infra.rsequipmentflashconfigpol)", 15568)
    ...
    prop._addConstant("infraRsLeafPGrpToCdpIfPol", "relation-to-cdp-interface-policy-for-mgmt-port-(infra.rsleafpgrptocdpifpol)", 16060)
    prop._addConstant("infraRsLeafPGrpToLldpIfPol", "relation-to-lldp-interface-policy-for-mgmt-port-(infra.rsleafpgrptolldpifpol)", 16062)
    ...
    prop._addConstant("infraRsSpinePGrpToCdpIfPol", "relation-to-cdp-interface-policy-for-mgmt-port-(infra.rsspinepgrptocdpifpol)", 16056)
    prop._addConstant("infraRsSpinePGrpToLldpIfPol", "relation-to-lldp-interface-policy-for-mgmt-port-(infra.rsspinepgrptolldpifpol)", 16058)
    ...
    prop._addConstant("infraRsWwnInstPol", "relation-to-access-wwn-policy-(infra.rswwninstpol)", 16433)
    ...
    prop._addConstant("ipv4NlbVip", "nlb-endpoint-(ipv4.nlbvip)", 13167)
    ...
    prop._addConstant("ipv6NlbVip", "nlb-endpoint-(ipv6.nlbvip)", 13169)
    ...
    prop._addConstant("leqptRsLsNodeToIf", "ethernet-interface-(leqpt.rslsnodetoif)", 3363)
    ...
    prop._addConstant("mldsnoopDom", "mld-snooping-domain-(mldsnoop.dom)", 5748)
    prop._addConstant("mldsnoopEntity", "mld-snooping-entity-(mldsnoop.entity)", 5761)
    prop._addConstant("mldsnoopInst", "mld-snooping-instance-(mldsnoop.inst)", 5762)
    prop._addConstant("mldsnoopQuerierSt", "querier-state-(mldsnoop.querierst)", 5750)
    prop._addConstant("mldsnoopRtrIf", "router-interface-(mldsnoop.rtrif)", 5752)
    ...
    prop._addConstant("pim6Dom", "pim6-domain-(pim6.dom)", 13640)
    prop._addConstant("pim6Entity", "pim6-entity-(pim6.entity)", 13646)
    prop._addConstant("pim6Inst", "pim6-instance-(pim6.inst)", 13647)
    ...
    prop._addConstant("polRsCtrlrFipsMode", "controller-fips-mode-(pol.rsctrlrfipsmode)", 9411)
    ...
    prop._addConstant("slaEntity", "ip-sla-(sla.entity)", 13180)
    prop._addConstant("slaICMPEcho", "icmp-echo-operation-(sla.icmpecho)", 13178)
    prop._addConstant("slaInst", "ip-sla-instance-(sla.inst)", 13181)
    prop._addConstant("slaOpCont", "container-for-ip-sla-operation-objects-(sla.opcont)", 13182)
    prop._addConstant("slaTCPConnect", "tcp-connect-operation-(sla.tcpconnect)", 13179)
    ...
    prop._addConstant("spanFltEntry", "acl-filter-entry-(span.fltentry)", 13147)
    prop._addConstant("spanFltGrp", "acl-filter-group-(span.fltgrp)", 13146)
    ...
    prop._addConstant("spanRsSpanSrcToFltGrpAtt", "source-to-filter-group-attachment-(span.rsspansrctofltgrpatt)", 13204)
    ...
    prop._addConstant("spanRsSpanSsnToFltGrpAtt", "filter-group-attachment-(span.rsspanssntofltgrpatt)", 13148)
    ...
    prop._addConstant("svcredirRsBackupDestAtt", "redirect-destination-(svcredir.rsbackupdestatt)", 15634)
    ...
    prop._addConstant("syntheticRsToAObj", "relation-to-a-object-(synthetic.rstoaobj)", 6925)
    prop._addConstant("syntheticRsToObj", "relation-to-object-(synthetic.rstoobj)", 4273)
    ...
    prop._addConstant("telemetryAlert", "telemetry-alerts-(telemetry.alert)", 14385)
    ...
    prop._addConstant("telemetryRequirement", "requirement-(telemetry.requirement)", 12539)
    ...
    prop._addConstant("topoctrlHashP", "user-defined-hash-policy-for-fabric-load-balance-policy-(topoctrl.hashp)", 13150)
    ...
    prop._addConstant("vzAnyDef", "any-definition-(vz.anydef)", 5642)
    prop._addConstant("vzAnyDefCont", "vzanydef-container-(vz.anydefcont)", 5641)
    prop._addConstant("vzAnyGroupDef", "any-group-definition-(vz.anygroupdef)", 9365)
    ...
    prop._addConstant("wwnEntity", "wwn-manager-entities-(wwn.entity)", 16419)
    prop._addConstant("wwnOui", "wwn-oui-instance-(wwn.oui)", 16420)
