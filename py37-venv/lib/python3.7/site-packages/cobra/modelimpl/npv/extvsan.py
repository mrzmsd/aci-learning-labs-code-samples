...
class ExtVsan(Mo):
    ...
    meta = ClassMeta("cobra.model.npv.ExtVsan")

    meta.moClassName = "npvExtVsan"
    meta.rnFormat = "vsan-%(id)s"
    meta.category = MoCategory.REGULAR
    meta.label = "NPV External Interface Vsan"
    ...
    prop = PropMeta("str", "fsmSt", "fsmSt", 24682, PropCategory.REGULAR)
    prop.label = "External Interface Vsan State"
    prop.isOper = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "id", "id", 24681, PropCategory.REGULAR)
    prop.label = "External Interface Vsan ID"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    prop.isNaming = True
