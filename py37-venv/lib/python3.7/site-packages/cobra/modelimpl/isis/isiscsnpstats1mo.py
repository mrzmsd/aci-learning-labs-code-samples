...
# ##################################################
class IsisCsnpStats1mo(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.isis.IsisCsnpStats1mo", "ISIS CSNP Packets")
    ...
    meta.moClassName = "isisIsisCsnpStats1mo"
    meta.rnFormat = "CDisisIsisCsnpStats1mo"
    meta.category = MoCategory.STATS_CURRENT
    meta.label = "current ISIS CSNP Packets stats in 1 month"
