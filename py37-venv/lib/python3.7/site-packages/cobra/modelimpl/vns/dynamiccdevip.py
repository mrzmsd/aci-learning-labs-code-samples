...
# ##################################################
class DynamicCDevIp(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.DynamicCDevIp")

    meta.moClassName = "vnsDynamicCDevIp"
    meta.rnFormat = "dCDevIp-%(name)s"
    meta.category = MoCategory.REGULAR
    meta.label = "IP Pool ip"
    ...
    prop = PropMeta("str", "address", "address", 44833, PropCategory.REGULAR)
    prop.label = "None"
    ...
    prop = PropMeta("str", "gateway", "gateway", 44835, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "ipNsName", "ipNsName", 44836, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 512)]
    ...
    prop = PropMeta("str", "name", "name", 44842, PropCategory.REGULAR)
    prop.label = "Name"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "netmask", "netmask", 44834, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
