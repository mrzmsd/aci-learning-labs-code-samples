...
class NodeInst(Mo):
    ...
    meta.childClasses.add("cobra.model.vns.RsNodeInstToCloudLDev")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.vns.RsNodeInstToCloudLDev", "rsNodeInstToCloudLDev"))
