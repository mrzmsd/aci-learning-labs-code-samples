...
class VGrpP(Mo):
    ...
    meta = ClassMeta("cobra.model.vns.VGrpP")

    meta.moClassName = "vnsVGrpP"
    meta.rnFormat = "vGrpP-[%(graphInstDn)s]"
    ...
    prop = PropMeta("str", "graphInstDn", "graphInstDn", 27027, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27045, PropCategory.REGULAR)
