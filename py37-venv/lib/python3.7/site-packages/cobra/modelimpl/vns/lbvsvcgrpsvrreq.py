...
# ##################################################
class LBVSvcGrpSvrReq(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = ClassMeta("cobra.model.vns.LBVSvcGrpSvrReq")

    meta.moClassName = "vnsLBVSvcGrpSvrReq"
    meta.rnFormat = "LB_SVC_GRP_SVR_C-%(ctrct)s-G-%(graph)s-F-%(node)s-LB_VSVR_NAME-%(lbName)s-LB_SVR_NAME-%(svrName)s"
    meta.category = MoCategory.REGULAR
    meta.label = "Normalized LB Service Group Server Configuration."
    ...
    prop = PropMeta("str", "annotation", "annotation", 38582, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ctrct", "ctrct", 28298, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "extMngdBy", "extMngdBy", 40721, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "graph", "graph", 28297, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "ip", "ip", 28282, PropCategory.REGULAR)
    prop.label = "Service Group Server IP"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("ip", prop)

    prop = PropMeta("str", "lbName", "lbName", 28299, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "node", "node", 28296, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop = PropMeta("str", "port", "port", 28283, PropCategory.REGULAR)
    prop.label = "Service Group Server Port"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 65535)]
    prop.defaultValue = 0
    ...
    prop = PropMeta("str", "svrName", "svrName", 28284, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.isCreateOnly = True
    ...
    prop.range = [(1, 64)]
    prop.regex = ['[a-zA-Z0-9_.:-]+']
    prop.defaultValue = "svrName"
    prop.defaultValueStr = "svrName"
    meta.props.add("svrName", prop)
    ...
    meta.namingProps.append(getattr(meta.props, "svrName"))
    ...
    def __init__(self, parentMoOrDn, ctrct, graph, node, lbName, svrName, markDirty=True, **creationProps):
        namingVals = [ctrct, graph, node, lbName, svrName]
