...
# ##################################################
class NATReq(Mo):
    meta = ClassMeta("cobra.model.vns.NATReq")

    meta.isAbstract = True
    meta.moClassName = "vnsNATReq"


    meta.moClassName = "vnsNATReq"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Basic firewall configuration."
    ...
    prop = PropMeta("str", "natRule", "natRule", 28259, PropCategory.REGULAR)
    prop.label = "None"
    prop.isConfig = True
    prop.isAdmin = True
    prop.range = [(0, 64)]
