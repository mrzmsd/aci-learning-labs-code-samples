...
# ##################################################
class L2RemoteUsageHist1year(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = StatsClassMeta("cobra.model.eqptcapacity.L2RemoteUsageHist1year", "Layer2 remote entries usage count")
    ...
    meta.moClassName = "eqptcapacityL2RemoteUsageHist1year"
    meta.rnFormat = "HDeqptcapacityL2RemoteUsage1year-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical Layer2 remote entries usage count stats in 1 year"
    ...
    meta.rnPrefixes = [
        ('HDeqptcapacityL2RemoteUsage1year-', True),
    ]
    ...
    prop = PropMeta("str", "index", "index", 36376, PropCategory.REGULAR)
