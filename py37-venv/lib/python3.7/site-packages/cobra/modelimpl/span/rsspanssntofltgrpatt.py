...
# ##################################################
class RsSpanSsnToFltGrpAtt(Mo):
    """
    Cardinality is n-to-1 which is the default

    """

    meta = SourceRelationMeta("cobra.model.span.RsSpanSsnToFltGrpAtt", "cobra.model.span.FltGrp")
    meta.cardinality = SourceRelationMeta.N_TO_ONE

    meta.moClassName = "spanRsSpanSsnToFltGrpAtt"
    meta.rnFormat = "rsspanSsnToFltGrpAtt"
    meta.category = MoCategory.RELATIONSHIP_TO_LOCAL
    meta.label = "Filter Group Attachment"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 45550, PropCategory.REGULAR)
    prop.label = "Monitoring policy attached to this observable object"
    prop.isImplicit = True
    prop.isAdmin = True
    meta.props.add("monPolDn", prop)

    prop = PropMeta("str", "operSt", "operSt", 45544, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 2
    ...
    prop = PropMeta("str", "operStQual", "operStQual", 45545, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop.defaultValue = 3
    ...
    prop = PropMeta("str", "parentSKey", "parentSKey", 45567, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(1, 65535)]
    ...
    prop = PropMeta("str", "spanCfgFailedBmp", "spanCfgFailedBmp", 47347, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("span:RsSpanSsnToFltGrpAttforceResolve_failed_flag", None, 4)
    prop._addConstant("span:RsSpanSsnToFltGrpAttlcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("span:RsSpanSsnToFltGrpAttmodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("span:RsSpanSsnToFltGrpAttmonPolDn_failed_flag", None, 128)
    prop._addConstant("span:RsSpanSsnToFltGrpAttparentSKey_failed_flag", None, 1024)
    prop._addConstant("span:RsSpanSsnToFltGrpAttrType_failed_flag", None, 8)
    prop._addConstant("span:RsSpanSsnToFltGrpAttstateQual_failed_flag", None, 32)
    prop._addConstant("span:RsSpanSsnToFltGrpAttstate_failed_flag", None, 16)
    prop._addConstant("span:RsSpanSsnToFltGrpAtttCl_failed_flag", None, 1)
    prop._addConstant("span:RsSpanSsnToFltGrpAtttDn_failed_flag", None, 2)
    prop._addConstant("span:RsSpanSsnToFltGrpAtttSKey_failed_flag", None, 16384)
    prop._addConstant("span:RsSpanSsnToFltGrpAtttType_failed_flag", None, 64)
    meta.props.add("spanCfgFailedBmp", prop)

    prop = PropMeta("str", "spanCfgFailedTs", "spanCfgFailedTs", 47349, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("spanCfgFailedTs", prop)

    prop = PropMeta("str", "spanCfgState", "spanCfgState", 47348, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "tCl", "tCl", 45547, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 45546, PropCategory.REGULAR)
    prop.label = "Target-dn"
    prop.isConfig = True
    prop.isAdmin = True
    meta.props.add("tDn", prop)

    prop = PropMeta("str", "tSKey", "tSKey", 45582, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
