...
class Ssh(Mo):
    ...
    prop = PropMeta("str", "passwordAuth", "passwordAuth", 53378, PropCategory.REGULAR)
    prop.label = "Password Auth State"
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = 1
    prop.defaultValueStr = "enabled"
    prop._addConstant("disabled", "disabled", 2)
    prop._addConstant("enabled", "enabled", 1)
    meta.props.add("passwordAuth", prop)
    ...
    prop.isConfig = True
    prop.isAdmin = True
    prop.defaultValue = "aes128-ctr,aes192-ctr,aes256-ctr,aes128-gcm@openssh.com,chacha20-poly1305@openssh.com"
    prop.defaultValueStr = "aes128-ctr,aes192-ctr,aes256-ctr,aes128-gcm@openssh.com,chacha20-poly1305@openssh.com"
    prop._addConstant("aes128-ctr", "aes128-ctr", 1)
    prop._addConstant("aes128-gcm@openssh.com", "aes128-gcm@openssh.com", 8)
    prop._addConstant("aes192-ctr", "aes192-ctr", 2)
    prop._addConstant("aes256-ctr", "aes256-ctr", 4)
    prop._addConstant("chacha20-poly1305@openssh.com", "chacha20-poly1305@openssh.com", 16)
