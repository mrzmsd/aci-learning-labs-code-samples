...
class SaRxKey(Mo):
    ...
    meta = ClassMeta("cobra.model.cloudsec.SaRxKey")

    meta.moClassName = "cloudsecSaRxKey"
    meta.rnFormat = "rxkey-%(assocNum)s"
    meta.category = MoCategory.REGULAR
    meta.label = "SA RX Key"
    ...
    prop = PropMeta("str", "assocNum", "assocNum", 42311, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "cloudsecCfgFailedBmp", "cloudsecCfgFailedBmp", 44655, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    prop._addConstant("cloudsec:SaRxKeyassocNum_failed_flag", None, 1)
    prop._addConstant("cloudsec:SaRxKeycipher_failed_flag", None, 2)
    prop._addConstant("cloudsec:SaRxKeykeyControl_failed_flag", None, 16)
    prop._addConstant("cloudsec:SaRxKeykey_failed_flag", None, 8)
    prop._addConstant("cloudsec:SaRxKeylcOwn_failed_flag", None, -9223372036854775808)
    prop._addConstant("cloudsec:SaRxKeymodTs_failed_flag", None, 2305843009213693952)
    prop._addConstant("cloudsec:SaRxKeymonPolDn_failed_flag", None, 16384)
    prop._addConstant("cloudsec:SaRxKeyrekeyNum_failed_flag", None, 512)
    prop._addConstant("cloudsec:SaRxKeysci_failed_flag", None, 1024)
    meta.props.add("cloudsecCfgFailedBmp", prop)

    prop = PropMeta("str", "cloudsecCfgFailedTs", "cloudsecCfgFailedTs", 44657, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    meta.props.add("cloudsecCfgFailedTs", prop)

    prop = PropMeta("str", "cloudsecCfgState", "cloudsecCfgState", 44656, PropCategory.REGULAR)
    prop.label = "None"
    prop.isOper = True
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 43460, PropCategory.REGULAR)
