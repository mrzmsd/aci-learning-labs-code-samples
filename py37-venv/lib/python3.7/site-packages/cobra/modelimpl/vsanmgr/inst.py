...
class Inst(Mo):
    """
     This objects hold per vsan-mgr instance information. There is only one instance of vsan-mgr running in the system today 

    """

    meta = ClassMeta("cobra.model.vsanmgr.Inst")

    meta.moClassName = "vsanmgrInst"
    meta.rnFormat = "inst"
    meta.category = MoCategory.REGULAR
    meta.label = "Vsan Manager Instance"
    ...
    meta.childClasses.add("cobra.model.vsanmgr.VsanMbrIf")

    meta.childNamesAndRnPrefix.append(("cobra.model.vsanmgr.VsanMbrIf", "vsanmbr-"))
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 27083, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "numConfiguredVsan", "numConfiguredVsan", 27080, PropCategory.REGULAR)
    prop.label = "Current Configured Vsan Count"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.range = [(0, 4096)]
    meta.props.add("numConfiguredVsan", prop)

    prop = PropMeta("str", "numCreatedVsan", "numCreatedVsan", 27081, PropCategory.REGULAR)
    prop.label = "Current Created Vsan Count"
    prop.isOper = True
    prop.range = [(0, 4096)]
    meta.props.add("numCreatedVsan", prop)
