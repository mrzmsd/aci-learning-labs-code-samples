...
class IfAdj(Mo):
    ...
    meta = ClassMeta("cobra.model.aib.IfAdj")

    meta.moClassName = "aibIfAdj"
    ...
    meta.childClasses.add("cobra.model.aib.IfAdjOwner")

    meta.childNamesAndRnPrefix.append(("cobra.model.aib.IfAdjOwner", "owner-"))

    meta.parentClasses.add("cobra.model.aib.If")
    ...
    prop = PropMeta("str", "addr", "addr", 53204, PropCategory.REGULAR)
    prop.label = "Address"
    prop.isConfig = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "if", "if", 53205, PropCategory.REGULAR)
