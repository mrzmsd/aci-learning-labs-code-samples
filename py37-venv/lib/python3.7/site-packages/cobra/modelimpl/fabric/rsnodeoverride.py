...
# ##################################################
class RsNodeOverride(Mo):
    """
    Mo doc not defined in techpub!!!

    """

    meta = SourceRelationMeta("cobra.model.fabric.RsNodeOverride", "cobra.model.fabric.AONodeS")
    meta.cardinality = SourceRelationMeta.N_TO_M

    meta.moClassName = "fabricRsNodeOverride"
    meta.rnFormat = "rsnodeOverride-[%(tDn)s]"
    ...
    prop = PropMeta("str", "monPolDn", "monPolDn", 26065, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tCl", "tCl", 26023, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tDn", "tDn", 26022, PropCategory.REGULAR)
