...
class Out(Mo):
    ...
    meta.childClasses.add("cobra.model.l3ext.RsRedistributePol")
    ...
    meta.childClasses.add("cobra.model.l3ext.VirtualLIfPTracker")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.RsRedistributePol", "rsredistributePol-"))
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.VirtualLIfPTracker", "vlifptracker"))
