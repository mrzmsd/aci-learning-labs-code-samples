...
class RsNodeDefL3OutAtt(Mo):
    ...
    meta.childClasses.add("cobra.model.l3ext.FloatingNodeDef")
    meta.childClasses.add("cobra.model.l3ext.AnchorNodeDef")
    ...
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.FloatingNodeDef", "floatingnodedef"))
    meta.childNamesAndRnPrefix.append(("cobra.model.l3ext.AnchorNodeDef", "anchornodedef"))
