...
# ##################################################
class LatencyAvg1Hist1qtr(Mo):
    """
    A class that represents historical statistics for delay(average mode-1) in a 1 quarter sampling interval.  This class updates every day.

    """

    meta = StatsClassMeta("cobra.model.latency.LatencyAvg1Hist1qtr", "delay(average mode-1)")
    ...
    meta.moClassName = "latencyLatencyAvg1Hist1qtr"
    meta.rnFormat = "HDlatencyLatencyAvg11qtr-%(index)s"
    meta.category = MoCategory.STATS_HISTORY
    meta.label = "historical delay(average mode-1) stats in 1 quarter"
    ...
    prop = PropMeta("str", "index", "index", 28991, PropCategory.REGULAR)
