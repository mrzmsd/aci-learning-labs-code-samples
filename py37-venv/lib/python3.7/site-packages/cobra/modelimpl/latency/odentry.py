...
# ##################################################
class OdEntry(Mo):
    meta = ClassMeta("cobra.model.latency.OdEntry")

    meta.isAbstract = True
    meta.moClassName = "latencyOdEntry"


    meta.moClassName = "latencyOdEntry"
    meta.rnFormat = ""
    meta.category = MoCategory.REGULAR
    meta.label = "Abstract Latency Entry Stats"
    ...
    meta.concreteSubClasses.add("cobra.model.latency.ExtToEpg")
    meta.concreteSubClasses.add("cobra.model.latency.EpToAny")
    meta.concreteSubClasses.add("cobra.model.latency.EpgToEpg")
    meta.concreteSubClasses.add("cobra.model.latency.EpToEpg")
    meta.concreteSubClasses.add("cobra.model.latency.AnyToEp")
    meta.concreteSubClasses.add("cobra.model.latency.EpgToEp")
    meta.concreteSubClasses.add("cobra.model.latency.ExtToEp")
    meta.concreteSubClasses.add("cobra.model.latency.IpToIp")
    meta.concreteSubClasses.add("cobra.model.latency.EpToEp")
    meta.concreteSubClasses.add("cobra.model.latency.EpToIp")
    meta.concreteSubClasses.add("cobra.model.latency.EpgToIp")
    ...
    prop = PropMeta("str", "localNodeId", "localNodeId", 28844, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "ruleName", "ruleName", 28840, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "tenantName", "tenantName", 28841, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "type", "type", 28842, PropCategory.REGULAR)
