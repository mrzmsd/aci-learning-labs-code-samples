...
class Nexthop(Mo):
    ...
    meta = ClassMeta("cobra.model.opflexp.Nexthop")

    meta.moClassName = "opflexpNexthop"
    meta.rnFormat = "dom-[%(vrf)s]-nh-[%(addr)s]"
    ...
    meta.parentClasses.add("cobra.model.opflexp.Route")
    ...
    prop = PropMeta("str", "Nhmetric", "Nhmetric", 54614, PropCategory.REGULAR)
    prop.label = "NhMetric"
    ...
    prop = PropMeta("str", "addr", "addr", 54612, PropCategory.REGULAR)
    ...
    prop = PropMeta("str", "flags", "flags", 54616, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    ...
    prop = PropMeta("str", "routeType", "routeType", 54615, PropCategory.REGULAR)
    prop.label = "None"
    prop.isImplicit = True
    prop.isAdmin = True
    prop.defaultValue = 1
    ...
    prop = PropMeta("str", "vrf", "vrf", 54613, PropCategory.REGULAR)
    ...
    def __init__(self, parentMoOrDn, vrf, addr, markDirty=True, **creationProps):
        namingVals = [vrf, addr]
